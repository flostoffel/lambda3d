...
#PARA AGREGAR PARA EL LOGIN/LOGOUT
from django.contrib.auth.forms import AuthenticationForm
from django.contrib.auth import login,authenticate
from django.contrib.auth.decorators import login_required

#AGREGAR PARA EL ENVIO DE MAIL
    ...
    def post(self,request,*args,**kwargs):
        if request.method=="POST":
            ...
            if form.is_valid():
                ...
                # contenido_mail_usuario = f'Hola {nombre}, gracias por contactarte con nosotros. En breve te estaremos asistiendo en lo que necesites. Saludos!'
                mensaje_a_usuario = """
